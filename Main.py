...
def main():
    ...
    dx = plot_psd(
        ...
        x_major_ticks=(0.1, 1, 10, 100,1000),   # your requested ticks
        x_limits=(0.1, 1000),
        annotate_dx=(10, 50, 90),
        #save_path="C:\Users\devli\OneDrive - Imperial College London\MSci - Devlin (Personal)\Data\Sample\RT\psd_As_Received.png",
        show=True,
    )
